...
#define FD_INIT_STATUS "fdlog_init" //初始化函数
...
#define FD_OPEN_STATUS "fdlog_open" //打开文件函数
...
#define FD_WRITE_STATUS "fdlog_write" //写入函数
...
#define FD_FLUSH_STATUS "fdlog_flush" //强制写入函数
